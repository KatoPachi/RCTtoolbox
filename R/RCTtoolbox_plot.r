...
#'
#' @name rctplot
#' @param obj R6 object class generated by methods of `RCTtoolbox`
#' @param zval numeric. z-value to construct error bars
#' Default is 1 (average +/- standard error).
#' @param xlab character. label of x-axis.
#' @param ylab character. label of y-axis.
#' @param title character. plot title.
#' @param caption character. plot caption.
#' @param inplot_lab_format character. format label showing results in plot.
#' Format is based on `glue::glue()`.
#' See `help(glue)` in details.
#' @param inplot_lab_size numeric. font size of in-plot label.
#' @param inplot_lab_adjust numeric. adjust in-plot label on y-axis.
#' @param ylim numeric vector. limit of y-axis.
#' @param flip logical. whether to swap axises?
#' @param patchwork logical.
#' whether to add a list of plots into one composition?
...
#'       "atest" = "A. Antibody Test",
#'       "avacc" = "B. Vaccination"
#'     ),
#'     inplot_lab_format = "{round(mean1, 3)}[{round(diff,3)}{pstar}]",
#'     inplot_lab_adjust = 0.025,
#'     ylim = c(-0.001, .2),
#'     flip = TRUE,
#'     ncol = 1
#' )
